...
const viewResume = async (application) => { updatingId.value = application.id; try { await companyService.viewApplicationResume(application.id) } catch { error.value = 'This student has not uploaded a resume.' } finally { updatingId.value = '' } }
